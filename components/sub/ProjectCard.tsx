    ...
    <div className="relative card overflow-hidden rounded-lg shadow-lg border border-[#2A0E61] flex flex-col h-[500px] w-100 mx-10  ">
      ...
      <div className="flex flex-col flex-1 p-4">
        ...
        <div className="flex flex-row w-full items-center mt-auto">
          <button className="z-30 w-1/4 px-1 py-2 text-white bg-gradient-to-r from-purple-600 to-cyan-500 rounded-lg shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            Tech Stack
          </button>
